<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Evolve.aspx.vb" Inherits="Order_Evolve" MasterPageFile="~/Site.Master" Title="Evolve Shutters" %>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-2 row">
                                <label class="col-lg-3 col-form-label required">SHUTTER TYPE</label>
                            ...
                            <div id="divDetail">
                                ...
                                <div class="mb-2 row" id="divLayoutCodeCustom">
                                    <label class="col-lg-3 col-form-label required">CUSTOM LAYOUT CODE</label>
                                    <div class="col-lg-5 col-md-12 col-sm-12">
                                ...
                                <div class="mb-3 mt-6 row" id="divSameSize">
                                    ...
                                    <div class="col-lg-3 col-md-12 col-sm-12">
                                        <div class="input-group">
                                            ...
                                            <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalInfo" onclick="return showInfo('Same Size Panels');"> ? </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-2 mt-5 row" id="divHorizontalTPost">
                                    ...
                                    <div class="col-lg-3 col-md-12 col-sm-12" id="divHorizontalTPostRequired">
                                        <div class="input-group">
                                            ...
                                            <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalInfo" onclick="return showInfo('Horizontal T-Post');"> ? </a>
                                        </div>
