...
Partial Class Setting_Customer_DiscountCustom
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Session("customerDiscount") = "" Then
            Response.Redirect("~/setting/customer/detail", False)
            Exit Sub
        End If

        lblCustomerId.Text = Session("customerDiscount")
        ...
        Try
            ...
            If msgError.InnerText = "" Then
                ...
                Using thisConn As New SqlConnection(myConn)
                    Using myCmd As SqlCommand = New SqlCommand("INSERT INTO CustomerDiscounts VALUES (@Id, 'CustomerAccount', @CustomerId, @DiscountType, @DesignId, @FabricId, @FabricColourId, @FabricCustom, @FabricProduct, @Discount, @StartDate, @EndDate, @FinalDiscount, 1)")
