<%@ Page Language="VB" AutoEventWireup="false" CodeFile="App.aspx.vb" Inherits="Setting_System_App" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Application" %>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter card-table table-hover table-striped" AutoGenerateColumns="false" AllowPaging="true" ShowHeaderWhenEmpty="true" EmptyDataText="APPLICATION DATA NOT FOUND :)" PageSize="50" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" OnPageIndexChanging="gvList_PageIndexChanging" OnRowCommand="gvList_RowCommand">
                                <RowStyle />
                                <Columns>
                ...
                <div class="modal-body">
                    <div class="mb-5 row">
                        <div class="col-12">
                            ...
                            <asp:TextBox runat="server" ID="txtName" CssClass="form-control" placeholder="Application Name ..." autocomplete="off"></asp:TextBox>
                        </div>
                    </div>
