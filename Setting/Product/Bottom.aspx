<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Bottom.aspx.vb" Inherits="Setting_Product_Bottom" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Bottom Rail" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="true" ShowHeaderWhenEmpty="true" EmptyDataText="BOTTOM RAIL DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" PageSize="50" OnPageIndexChanging="gvList_PageIndexChanging" OnRowCommand="gvList_RowCommand">
                                <RowStyle />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Product" ItemStyle-Wrap="true">
                                        <ItemTemplate>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-8">
                            <label class="form-label required">BOTTOM RAIL NAME</label>
                    ...
                    <div class="mb-5 row">
                        <div class="col-12">
                            <label class="form-label required">Tube Type</label>
    ...
    <div class="modal modal-blur fade" id="modalDelete" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:Button runat="server" ID="Button1" Text="Cancel" CssClass="btn" OnClick="btnCancel_Click" />
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            ["lbDesign", "lbTube", "lbControl"].forEach(initializeTomSelect);
        });
    </script>
