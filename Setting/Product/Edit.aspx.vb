...
Partial Class Setting_Product_Edit
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        lblId.Text = UCase(Session("productDetail")).ToString()
        ...
        Try
            ...
            If msgError.InnerText = "" Then
                ...
                Using thisConn As New SqlConnection(myConn)
                    Using myCmd As SqlCommand = New SqlCommand("UPDATE Products SET DesignId=@DesignId, BlindId=@BlindId, Name=@Name, TubeType=@TubeType, ControlType=@ControlType, ColourType=@ColourType, Description=@Description, Active=@Active WHERE Id=@Id")
                ...
                If Session("productAction") = "Edit" Then
                    Response.Redirect("~/setting/product", False)
                    Exit Sub
                End If
    ...
    Private Sub BindDataProduct(Id As String)
        ...
        Try
            ...
            ddlDesignId.SelectedValue = designId
