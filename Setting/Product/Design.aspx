<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Design.aspx.vb" Inherits="Setting_Product_Design" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Design Type" %>
                ...
                <div class="modal-body">
                    <div class="mb-4 row">
                        <div class="col-12">
                            ...
                            <asp:TextBox runat="server" ID="txtName" CssClass="form-control" placeholder="Design Name ..." autocomplete="off"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 row">
                        <div class="col-12">
                            ...
                            <asp:DropDownList runat="server" ID="ddlType" CssClass="form-select">
                                ...
                                <asp:ListItem Value="Veri Shades" Text="Veri Shades"></asp:ListItem>
                                <asp:ListItem Value="Zebra Blind" Text="Zebra Blind"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 row">
                        <div class="col-12">
                            ...
                            <asp:TextBox runat="server" ID="txtPage" CssClass="form-control" placeholder="Page Url ..." autocomplete="off"></asp:TextBox>
                        </div>
                    </div>
