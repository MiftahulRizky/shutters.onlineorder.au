<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Chain.aspx.vb" Inherits="Setting_Product_Chain" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Chain / Remote" %>
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Chain / Remote</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Chain / Remote</h3>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="true" ShowHeaderWhenEmpty="true" EmptyDataText="CHAIN / REMOTE DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" PageSize="25" OnPageIndexChanging="gvList_PageIndexChanging" OnRowCommand="gvList_RowCommand">
                                <RowStyle />
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NewTube" HeaderText="Tube Type" />
                                    <asp:BoundField DataField="NewControl" HeaderText="Control Type" />
                ...
                <div class="modal-body">
                    <div class="mb-3 row">
                        <div class="col-5">
                            ...
                            <asp:TextBox runat="server" ID="txtBoeId" TextMode="Number" CssClass="form-control" placeholder="BOE ID ..." autocomplete="off"></asp:TextBox>
                        </div>
                        <div class="col-7">
                            <label class="form-label required">Name</label>
                            <asp:TextBox runat="server" ID="txtName" CssClass="form-control" placeholder="Chain / Remote Name ..." autocomplete="off"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <div class="col-12">
                            ...
                            <asp:ListBox runat="server" ID="lbControl" CssClass="form-select" SelectionMode="multiple" ClientIDMode="Static"></asp:ListBox>
                        </div>
                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            function initializeTomSelect(elementId) {
                ...
                new TomSelect(el, {
                    ...
                    dropdownParent: document.getElementById("#modalProccess"),
                    controlInput: "<input>",
                    render: {
                        item: function (data, escape) {
                            return `<div>${data.customProperties ? `<span class="dropdown-item-indicator">${data.customProperties}</span>` : ''}${escape(data.text)}</div>`;
                        },
            ...
            ["lbDesign", "lbControl", "lbTube"].forEach(initializeTomSelect);
        });
    </script>
