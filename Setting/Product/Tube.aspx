<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tube.aspx.vb" Inherits="Setting_Product_Tube" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Tube Type" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Tube</h3>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="true" ShowHeaderWhenEmpty="true" EmptyDataText="TUBE DATA NOT FOUND :)" PageSize="50" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" OnPageIndexChanging="gvList_PageIndexChanging" OnRowCommand="gvList_RowCommand">
                                <RowStyle />
                                <Columns>
                ...
                <div class="modal-body">
                    <div class="mb-5 row">
                        <div class="col-12">
                            ...
                            <asp:TextBox runat="server" ID="txtName" CssClass="form-control" placeholder="Tube Name ..." autocomplete="off"></asp:TextBox>
                        </div>
                    </div>
