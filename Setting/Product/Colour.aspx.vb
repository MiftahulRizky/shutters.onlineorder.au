...
Partial Class Setting_Product_Colour
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            txtSearch.Text = Session("colourSearch")
        ...
        If Not String.IsNullOrEmpty(e.CommandArgument) Then
            ...
            If e.CommandName = "Detail" Then
                ...
                Try
                    ...
                    Dim myData As DataSet = settingCfg.GetListData("SELECT * FROM ProductColours WHERE Id = '" + lblId.Text + "'")
            ...
            ElseIf e.CommandName = "Log" Then
                ...
                Try
                    gvListLogs.DataSource = settingCfg.GetListData("SELECT * FROM Log_Products WHERE DataId = '" + dataId + "' AND Type='ProductColours' ORDER BY ActionDate DESC")
                    gvListLogs.DataBind()
    ...
    Protected Sub btnSubmitProcess_Click(sender As Object, e As EventArgs)
        ...
        Try
            If txtName.Text = "" Then
                MessageError_Process(True, "COLOUR NAME IS REQUIRED !")
                ClientScript.RegisterStartupScript(Me.GetType(), "showProcess", thisScript, True)
                Exit Sub
            End If
            ...
            If msgErrorProcess.InnerText = "" Then
                ...
                If lblAction.Text = "Add" Then
                    ...
                    Session("colourSearch") = txtSearch.Text
                    Response.Redirect("~/setting/product/colour", False)
                End If
                If lblAction.Text = "Edit" Then
                    Using thisConn As New SqlConnection(myConn)
                        Using myCmd As SqlCommand = New SqlCommand("UPDATE ProductColours SET Name=@Name, Description=@Description, Active=@ACtive WHERE Id=@Id")
                    ...
                    Dim dataLog As Object() = {"ProductColours", lblId.Text, Session("LoginId").ToString(), "Colour Type Updated"}
                    settingCfg.Log_Product(dataLog)
    ...
    Protected Sub btnSubmitDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using myCmd As SqlCommand = New SqlCommand("DELETE FROM ProductColours WHERE Id=@Id")
                    myCmd.Parameters.AddWithValue("@Id", lblId.Text)
    ...
    Private Sub BindData(SearchText As String)
        Try
            ...
            End If
            Dim thisQuery As String = String.Format("SELECT *, CASE WHEN Active = 1 THEN 'Yes' WHEN Active = 0 THEN 'No' ELSE 'Error' END AS DataActive FROM ProductColours {0} ORDER BY Name ASC", search)
