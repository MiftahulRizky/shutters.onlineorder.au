<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Access.aspx.vb" Inherits="System_Access" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Error.Master" Debug="true" Title="Login Access" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="empty-img">
        <asp:Image runat="server" Height="128px" ImageUrl="~/Content/static/illustrations/login_access.svg" />
    </div>
