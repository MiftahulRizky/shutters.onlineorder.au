...
function bindBlindType(designId) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "BlindTypeRoller", designtype: designId };
        $.ajax({
            type: "POST",
...
function bindColourType(blindId) {
    return new Promise((resolve, reject) => {
        ...
        const listData = { type: "ColourType", blindtype: blindId, tubetype: "N/A", controltype: "N/A" };
        $.ajax({
            type: "POST",
            url: "Method.aspx/ListData",
            data: JSON.stringify({ data: listData }),
...
function bindComponent(category) {
    ...
    const componentOptions = {
        "Louvres": [
            "63mm Louvre", "89mm Louvre", "114mm Louvre",
            "Standard Louvre Pin", "Louvre Repair Pin"
        ],
        "Framing | Hinged": [
            "Beaded L Frame 48mm", "Insert L Frame 50mm", "Insert L Frame 63mm",
            "Flat L Frame", "Small Bullnose Z Frame", "Large Bullnose Z Frame",
            "Colonial Z Frame", "Small Bullnose Sill Plate", "Large Bullnose Sill Plate",
            "Colonial Bullnose Sill Plate", "Top U Channel", "Bottom U Channel"
        ],
        ...
        "Framing | Fixed": [
            "Top U Channel", "Bottom U Channel"
        ],
        "Posts": [
            "T-Post", "90° Corner Post", "135° Bay Post", "Post Mounting Bracket"
        ],
        "Extrusion": [
...
function isLengthVisible(category, component) {
    const lengthCategories = new Set([
        "Louvres", "Framing | Hinged", "Framing | Bi-fold or Sliding",
        "Framing | Fixed", "Posts", "Extrusion", "Track Hardware"
    ]);
...
function proccess() {
    ...
    $.ajax({
        type: "POST",
        url: "Method.aspx/PanoramaPartsProccess",
